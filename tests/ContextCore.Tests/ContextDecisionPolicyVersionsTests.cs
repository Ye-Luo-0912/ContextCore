...
/// <summary>
/// OPT-4 验收测试：验证 ContextDecisionPolicyVersions 按能力独立演进，
...
{
    /// <summary>OPT-4: 5 个能力作用域的版本常量字符串格式为 "capability-name/version"。</summary>
    [TestMethod]
    ...
    /// <summary>OPT-4: 历史别名 V17_0 等价于新常量 DecisionSchemaV2_0（向后兼容）。</summary>
    [TestMethod]
    ...
    /// <summary>OPT-4: 历史别名 V18_0 等价于新常量 QualityContractV1_0（向后兼容）。</summary>
    [TestMethod]
    ...
    /// <summary>OPT-4: 历史别名不再包含全项目阶段编号字符串（v17.0/v18.0 等）。</summary>
    [TestMethod]
    ...
    /// <summary>OPT-4: ContextDecisionRecord 默认 PolicyVersion 为 DecisionSchemaV2_0（按能力命名）。</summary>
    [TestMethod]
    ...
    /// <summary>OPT-4: ContextDecisionAuditReport 默认 PolicyVersion 为 DecisionSchemaV2_0。</summary>
    [TestMethod]
    ...
    /// <summary>OPT-4: PackageQualityReport 默认 PolicyVersion 为 QualityContractV1_0。</summary>
    [TestMethod]
    ...
    /// <summary>OPT-4: DecisionEvidenceV2Result 默认 PolicyVersion 为 QualityContractV1_0。</summary>
    [TestMethod]
