...
// ===========================================================================
// P0-6：Real Model E2E — 加载实际 ONNX 文件的端到端测试
//
// 目标：
...
public sealed class P0_6_RealOnnxFileE2ETests
{
    ...
    // ===========================================================================
    // §2 工厂拒绝错误张量名（证明真实读取了模型 metadata）
    // ===========================================================================
    ...
    // ===========================================================================
    // §3 ModelActivationManager 完整激活流程（真实 ONNX 文件）
    // ===========================================================================
    ...
    // ===========================================================================
    // §4 真实模型推理调用 ONNX Runtime（embedding 模型输入类型不匹配 → 优雅失败）
    // ===========================================================================
    ...
    // ===========================================================================
    // §5 ActivateLatestAsync 解析最新版本（真实 ONNX 文件）
    // ===========================================================================
    ...
    // ===========================================================================
    // §6 激活失败后回退到 fallback（真实文件路径不存在时）
    // ===========================================================================
