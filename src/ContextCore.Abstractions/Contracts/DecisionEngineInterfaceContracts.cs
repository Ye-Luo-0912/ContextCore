...
public sealed class ContextDecisionOutcomeSummary
{
    ...
    /// <summary>
    /// 决策诊断字典。记录 mandatory overflow / hard window violation 等
