    ...
    internal static IReadOnlyList<string> CommandRows(bool compact, bool serviceMode = false)
    {
        if (serviceMode)
        {
            return compact
                ?
                [
                    "[R] 刷新  [A] 自动  [S] 服务  [I] Ingest  [G] Query  [V] Package  [J] Jobs  [M] Model  [U] Admin  [Y] Memory  [K] Constraints  [30] Gaps  [31] CandConstraints  [L] Relations  [O] Policy  [T] ShortTerm  [N] Promotion  [Z] StableReview  [H] Learning  [35] CandidateMemory  [36] StableMemory  [37] VectorIndex  [Q] 退出"
                ]
                :
                [
                    "[R] 刷新  [A] 自动  [S] 服务  [I] Ingest  [G] Query  [V] Package  [J] Jobs  [M] Model  [U] Admin  [Y] Memory  [K] Constraints  [30] Gaps  [31] CandConstraints  [L] Relations  [O] Policy  [T] ShortTerm  [N] Promotion  [Z] StableReview  [H] Learning  [35] CandidateMemory  [36] StableMemory  [37] VectorIndex  [Q] 退出",
