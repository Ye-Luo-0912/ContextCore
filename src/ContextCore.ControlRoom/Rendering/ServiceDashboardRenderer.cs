...
public static class ServiceDashboardRenderer
{
    ...
    public static string RenderToString(ServiceDashboardSnapshot snapshot)
    {
        ...
        builder.AppendLine("----");
        builder.AppendLine("[R] 刷新状态  [D] 深度刷新  [I] Ingest  [G] Query  [V] Package  [J] Jobs  [M] Model  [U] Admin  [Y] Memory  [K] Constraints  [C] ConstraintGaps  [E] CandidateConstraints  [L] Relations  [O] Policy  [T] ShortTerm  [N] Promotion  [H] Learning  [X] Planning  [35] CandidateMemory  [36] StableMemory  [37] VectorIndex  [B/0] 返回  [Q] 退出");
