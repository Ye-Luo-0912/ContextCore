...
public static class ReportSummaryRegistry
{
    ...
    public static readonly ControlRoomReportDescriptor V8FormalRetrievalPromotionReadinessAudit = new()
    {
        ReportId = "FormalRetrievalPromotionReadinessAudit",
        DisplayTitle = "V8.0 Formal Retrieval Promotion Readiness Audit Summary",
        PrimaryPath = "vector/v8/formal-retrieval-promotion-readiness-audit.json",
        GatePath = "vector/v8/formal-retrieval-promotion-readiness-gate.json",
        PhaseGroup = "V8",
        EvalGateCommand = "eval formal-retrieval-promotion-readiness-gate",
    ...
    public static readonly ControlRoomReportDescriptor V8FormalRetrievalPromotionApproval = new()
    {
        ReportId = "FormalRetrievalPromotionApproval",
        DisplayTitle = "V8.2 Formal Retrieval Promotion Approval Summary",
        PrimaryPath = "vector/v8/formal-retrieval-promotion-approval.json",
        GatePath = "vector/v8/formal-retrieval-promotion-approval-gate.json",
        PhaseGroup = "V8",
        EvalGateCommand = "eval formal-retrieval-promotion-approval-gate",
    ...
    public static readonly ControlRoomReportDescriptor V8FormalRetrievalPromotionExternalApprovalIntake = new()
    {
        ReportId = "FormalRetrievalPromotionExternalApprovalIntake",
        DisplayTitle = "V8.4 Formal Retrieval Promotion External Approval Intake Summary",
        PrimaryPath = "vector/v8/formal-retrieval-promotion-external-approval-intake.json",
        GatePath = "vector/v8/formal-retrieval-promotion-external-approval-intake-gate.json",
        PhaseGroup = "V8",
        EvalGateCommand = "eval formal-retrieval-promotion-external-approval-intake-gate",
        EvalPlanCommand = "eval formal-retrieval-promotion-external-approval-intake",
    };

    public static readonly ControlRoomReportDescriptor V8FormalRetrievalPromotionExternalApprovalSubmissionPack = new()
    {
        ReportId = "FormalRetrievalPromotionExternalApprovalSubmissionPack",
        DisplayTitle = "V8.5 Formal Retrieval Promotion External Approval Submission Pack Summary",
        PrimaryPath = "vector/v8/formal-retrieval-promotion-external-approval-submission-pack.json",
        GatePath = "vector/v8/formal-retrieval-promotion-external-approval-submission-pack-gate.json",
        PhaseGroup = "V8",
        EvalGateCommand = "eval formal-retrieval-promotion-external-approval-submission-pack-gate",
