...
public static partial class EvalCommand
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        !string.Equals(subcommand, "fs-vector-perf", StringComparison.OrdinalIgnoreCase))
        {
            ...
            Console.WriteLine("  eval learning-evidence-calibrated-self-validation-pack");
            ...
            Console.WriteLine("  eval learning-formal-evidence-boundary-pack");
            Console.WriteLine("  eval learning-formal-evidence-boundary-pack-gate");
            Console.WriteLine("  eval learning-formal-evidence-realization-pack");
        ...
        if (string.Equals(subcommand, "learning-shadow-promotion-readiness-pack", StringComparison.OrdinalIgnoreCase)
            || string.Equals(subcommand, "learning-shadow-promotion-readiness-pack-gate", StringComparison.OrdinalIgnoreCase))
        {
        ...
        if (string.Equals(subcommand, "learning-evidence-calibrated-self-validation-pack", StringComparison.OrdinalIgnoreCase)
            || string.Equals(subcommand, "learning-evidence-calibrated-self-validation-pack-gate", StringComparison.OrdinalIgnoreCase))
        {
            await ExecuteLearningEvidenceCalibratedSelfValidationPackAsync(args, subcommand, cancellationToken).ConfigureAwait(false);
            return;
        }
        if (string.Equals(subcommand, "learning-evidence-accumulation-pack", StringComparison.OrdinalIgnoreCase)
            || string.Equals(subcommand, "learning-evidence-accumulation-pack-gate", StringComparison.OrdinalIgnoreCase))
        {
        ...
        if (string.Equals(subcommand, "learning-formal-evidence-boundary-pack", StringComparison.OrdinalIgnoreCase)
            || string.Equals(subcommand, "learning-formal-evidence-boundary-pack-gate", StringComparison.OrdinalIgnoreCase))
        {
            await ExecuteLearningFormalEvidenceBoundaryPackAsync(args, subcommand, cancellationToken).ConfigureAwait(false);
            return;
        }
        if (string.Equals(subcommand, "learning-formal-evidence-realization-pack", StringComparison.OrdinalIgnoreCase)
            || string.Equals(subcommand, "learning-formal-evidence-realization-pack-gate", StringComparison.OrdinalIgnoreCase))
        {
            await ExecuteLearningFormalEvidenceRealizationPackAsync(args, subcommand, cancellationToken).ConfigureAwait(false);
            return;
        }
        if (string.Equals(subcommand, "learning-controlled-formal-label-ingestion-staging", StringComparison.OrdinalIgnoreCase)
            || string.Equals(subcommand, "learning-controlled-formal-label-ingestion-staging-gate", StringComparison.OrdinalIgnoreCase))
        {
        ...
        if (string.Equals(subcommand, "learning-controlled-formal-label-ingestion-staging-r1-pack", StringComparison.OrdinalIgnoreCase)
            || string.Equals(subcommand, "learning-controlled-formal-label-ingestion-staging-r1-pack-gate", StringComparison.OrdinalIgnoreCase))
        {
        ...
        if (string.Equals(subcommand, "feedback-loop-eval", StringComparison.OrdinalIgnoreCase))
        {
            await ExecuteFeedbackLoopEvalAsync(cancellationToken).ConfigureAwait(false);
            return;
        }
