        ...
        CancellationToken cancellationToken)
    {
        ...
        if (inputs.HardConstraints is not null)
        {
            ...
            foreach (var item in inactiveHardConstraints)
            {
                ...
                droppedItems.Add(PackageTraceRecorder.CreateDropped(c, "constraint is deprecated or rejected"));
            }
            ...
            if (deprecatedWorking.Length > 0)
            {
                ...
                else
                {
                    ...
                    foreach (var pair in deprecatedWorkingPairs)
                    {
                        ...
                        droppedItems.Add(PackageTraceRecorder.CreateDropped(c, "deprecated memory is excluded in non-audit mode"));
                    }
                }
            }
        }
        ...
        if (_graphExpansionCoordinator.IsConfigured && selectedSourceIds.Count > 0)
        {
