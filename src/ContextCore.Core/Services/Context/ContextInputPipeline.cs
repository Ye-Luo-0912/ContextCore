...
public sealed class ContextInputIngestionService
{
        ...
        IWriteTransactionScopeFactory? transactionScopeFactory = null)
    {
        ...
        // P1-3：传入 IWriteTransactionScopeFactory。Postgres provider 注册后，摄取走 P0-3 事务路径——
        ...
        _ingestionService = new BasicContextIngestionService(
            contextStore, relationProjector, relationStore, projectionWriter, transactionScopeFactory);
    }
